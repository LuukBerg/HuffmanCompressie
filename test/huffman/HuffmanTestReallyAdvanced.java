 ...
 * @author Brian
 */
public class HuffmanTestReallyAdvanced {
    public String data;
    public String data2;
    public HashMap<Character,String> cheatSheet;
    public TimeStamp timer;
    public HuffmanTestReallyAdvanced() {
    }
    ...
    public void testGetFrequentie() {
        ...
        expResult.put(' ', 120000);
        expResult.put('a', 80000);
        expResult.put('e', 60000);
        expResult.put('h', 20000);
        expResult.put('i', 60000);
        expResult.put('j', 20000);
        expResult.put('l', 40000);
        expResult.put('m', 60000);
        expResult.put('n', 60000);
        expResult.put('o', 20000);
        expResult.put('r', 40000);
        expResult.put('s', 60000);
        expResult.put('t', 80000);
        expResult.put('u', 20000);
